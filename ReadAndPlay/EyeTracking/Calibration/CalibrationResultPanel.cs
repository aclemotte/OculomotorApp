...
//using Point = System.Drawing.Point; original tenia esta linea, pero me parece q esta mal
...
namespace LookAndPlayForm
{
    public partial class CalibrationResultPanel : Control
    {
        ...
        private IEnumerable<Tobii.Gaze.Core.CalibrationPointData> _calibrationDataEyeX;
        //private TETCSharpClient.Data.CalibrationResult _calibrationDataEyeTribe;
        ...
        public void Initialize(IEnumerable<Tobii.Gaze.Core.CalibrationPointData> calibrationData)
        {
            _calibrationDataEyeX = calibrationData;
            ExtractCalibrationPoints();

            Invalidate();
        }

        //public void Initialize(TETCSharpClient.Data.CalibrationResult calibrationData)
        //{
        //    _calibrationDataEyeTribe = calibrationData;
        //    //ExtractCalibrationPoints(); esta funcion hay que modificar
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            if (_calibrationDataEyeX != null && _calibrationPoints != null)
            {
                using (Pen pen = new Pen(Color.DarkGray))
                {
                    ...
                    foreach (var plotItem in _calibrationDataEyeX)
                    {
